...
from dtuimldmtools import bmplot, feature_selector_lr, rlr_validate, train_neural_net, draw_neural_net
import sklearn
...
def ann_outer(hidden_units_matrix, val_error_matrix, data_val_len, data_outer_train_length,
              ...
              k_outer, optimal_regularization_param_ANN, test_errors_outer_ANN,
    ...
    optimal_regularization_param_ANN.append(optimal_units)
    ...
    return optimal_regularization_param_ANN, test_errors_outer_ANN
